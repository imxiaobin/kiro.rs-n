...
pub struct Config {
    ...
    /// 负载均衡模式（"priority"、"balanced" 或 "proxy_pair_rotation"）
    #[serde(default = "default_load_balancing_mode")]
    pub load_balancing_mode: String,

    /// 代理轮换模式的切换周期（分钟）
    #[serde(default = "default_proxy_pair_rotation_interval_minutes")]
...
fn default_proxy_pair_rotation_interval_minutes() -> u64 {
    60
}

fn default_proxy_pair_rotation_group_size() -> usize {
    2
}
